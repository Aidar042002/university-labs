...
//        String persistenceUnitName = "webLabPU";
...
//            point.setX(BigDecimal.valueOf(Double.parseDouble(String.valueOf(new BigDecimal(x)))));
//            point.setY(new BigDecimal((y)));
////            try {
////                throw new RuntimeException(String.valueOf(y));
////            }catch (Exception e){
////                resultMessage = "Ошибка: " + e.getMessage();
////                e.printStackTrace();
////            }
//            point.setR(new BigDecimal(r));
//            point.setHit(hit);
//
//            em.persist(point);
...
//            resultMessage = "Успешное создание записи в базе данных!";
//            closeEntityManager(em);
//        } catch (Exception e) {
//            resultMessage = "Ошибка подключения к базе данных: " + e.getMessage();
//            e.printStackTrace();
//        }
...
//            resultMessage = "Все записи успешно удалены!";
//            closeEntityManager(em);
//        } catch (Exception e) {
//            resultMessage = "Ошибка при удалении всех записей: " + e.getMessage();
//            e.printStackTrace();
//        }
//    }
//}
